...
export class ForbiddenFood extends Component {
    static displayName = ForbiddenFood.name;
                ...
                <Card style={{ width: '100%' }}>
                    <Card.Header variant="top" src="holder.js/100px180?text=Image cap">
                        <div style={{ float: 'left' }}>
                            <h4>Alimentos No Permitidos</h4>
                            <p>
                                Lista de Alimentos No Permitidos para la app.
                        </p>
